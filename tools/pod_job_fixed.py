...
segment from the public S3 bucket, runs scrollprize/PHerc.1667-iteration-5
...
INK = SEG + "ink-detection/downsampled/PHercParis4-20230702185753-1.129um-0.23m-78keV-volume-20260608103018-L1-20260709123958-mrg20736-1um-s1z2-tile256-stride128-ds8.jpg"
OUT = "/workspace/out"
import numpy as _np
